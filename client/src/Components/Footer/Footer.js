...
export const Footer = () => {
  const links = {
    ...
    'https://mail.google.com/mail/?view=cm&fs=1&to=mickrothnyc@gmail.com': '<i class="fa fa-envelope" aria-hidden="true" style="background:transparent;font-size:2em;color:lightBlue"></i>',
